...
def make_glacier_stack(glims_id: str = "G014442E77835N"):
    ...
    rgi = gpd.read_file("data/rgi/rgi7/RGI2000-v7.0-G-07_svalbard_jan_mayen/RGI2000-v7.0-G-07_svalbard_jan_mayen.shp").query(f"glims_id == '{glims_id}'").to_crs(crs).iloc[0]
    ...
    aster = surgedetection.inputs.aster.get_filepaths(crs=crs)
    ...
    attrs = {"crs": crs.to_wkt(), "resolution": [mod, mod], "height_px": shape[0], "width_px": shape[1], "glacier_geometry": rgi.geometry.wkt, "bounding_box": bounding_box}
